...
Annual.total.eff.hours=read.csv(handl_OneDrive('Analyses/Data_outs/Annual.total.eff.hours.csv'))
Annual.total.eff.hours$Total=1000*Annual.total.eff.hours$Total  #convert to 1000s of km gn h


#Sofar TEPS
Current.yr="2018_19"
SOFAR.TEPS=read.csv(paste(handl_OneDrive("Data/Catch and Effort"),Current.yr,"TEPS_PROTECTEDSP.csv",sep='/'))
...
hndl.teps=handl_OneDrive('Analyses/Ecosystem indices and multivariate/Shark-bycatch/Outputs/TEPS/')
